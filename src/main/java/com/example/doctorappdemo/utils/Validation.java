package com.example.doctorappdemo.utils;
...
public class Validation {
    ...
    public static final String USERNAME_REGEX_PATTERN = "^[A-Za-z0-9]{8,16}$";
    public static final String PASSWORD_REGEX_PATTERN = "^([A-za-z0-9][!_$&*^%]){8,16}$";
